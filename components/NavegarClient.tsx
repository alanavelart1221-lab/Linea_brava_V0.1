        ...
        {started ? (
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-3 text-center">
              <Stat label="Distancia" value={distanceKm != null ? `${distanceKm} km` : "—"} />
              <Stat label="Duración" value={duration ?? "—"} />
              <Stat label="Desnivel" value={elevationM != null ? `${elevationM} m` : "—"} />
            </div>
            <button
